...
var $author$project$Main$FetchedWords = function (a) {
	return {$: 'FetchedWords', a: a};
};
...
var $author$project$Main$initialCmd = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$Main$FetchedWords),
		url: './words.txt'
	});
var $author$project$Main$Loading = {$: 'Loading'};
var $author$project$Main$initialModel = $author$project$Main$Loading;
...
var $author$project$Main$keyPressToMsg = function (string) {
	var key = function () {
...
var $author$project$Main$chooseNewWord = function (wordList) {
	if (!wordList.b) {
		return $elm$core$Platform$Cmd$none;
	} else {
		var firstWord = wordList.a;
		var rest = wordList.b;
		return A2(
			$elm$random$Random$generate,
			function (word) {
				return $author$project$Main$GameMsg(
					$author$project$Main$NewWord(word));
			},
			A2($elm$random$Random$uniform, firstWord, rest));
	}
};
...
var $author$project$Main$initialGameState = {
	badGuesses: _List_Nil,
	lifeCount: 8,
	puzzle: $elm$core$String$toList('______'),
	solution: $elm$core$String$toList('ZEPHYR')
};
var $elm$core$String$lines = _String_lines;
var $author$project$Main$playerLost = function (gameState) {
	return gameState.lifeCount < 1;
};
...
var $author$project$Main$playerWon = function (gameState) {
	return !A2(
		$elm$core$List$member,
		_Utils_chr('_'),
		gameState.puzzle);
};
var $author$project$Main$gameIsOver = function (gameState) {
	return $author$project$Main$playerLost(gameState) || $author$project$Main$playerWon(gameState);
};
...
var $author$project$Main$updatePlayAgain = function (wordList) {
	return _Utils_Tuple2(
		$author$project$Main$initialGameState,
		$author$project$Main$chooseNewWord(wordList));
};
...
var $author$project$Main$updateWithGuess = F2(
	function (upperChar, gameState) {
		if (A2($elm$core$List$member, upperChar, gameState.solution)) {
			var zipped = A2($elm_community$list_extra$List$Extra$zip, gameState.puzzle, gameState.solution);
			var puzzle = A2(
				$elm$core$List$map,
				function (_v0) {
					var pchar = _v0.a;
					...
					return (_Utils_eq(
						pchar,
						_Utils_chr('_')) && _Utils_eq(schar, upperChar)) ? schar : pchar;
				},
				zipped);
			return _Utils_Tuple2(
				_Utils_update(
			...
			if ($elm$core$Char$isAlpha(upperChar) && (!A2($elm$core$List$member, upperChar, gameState.badGuesses))) {
				return _Utils_Tuple2(
					_Utils_update(
						gameState,
						{
							badGuesses: A2($elm$core$List$cons, upperChar, gameState.badGuesses),
...
var $author$project$Main$updateGameState = F3(
	function (msg, wordList, gameState) {
		var _v0 = _Utils_Tuple2(
			msg,
			$author$project$Main$gameIsOver(gameState));
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 'ClickedPlayAgain':
					var _v1 = _v0.a;
					return $author$project$Main$updatePlayAgain(wordList);
				case 'NewWord':
					var word = _v0.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							$author$project$Main$initialGameState,
							{
								puzzle: A2(
									...
									_Utils_chr('_')),
								solution: $elm$core$String$toList(
									$elm$core$String$toUpper(word))
							}),
						$elm$core$Platform$Cmd$none);
				default:
					if (_v0.a.a.$ === 'Control') {
						if ((_v0.a.a.a === 'Enter') && _v0.b) {
							return $author$project$Main$updatePlayAgain(wordList);
						} else {
							break _v0$5;
						}
						...
						if (_v0.b) {
							if (' ' === _v0.a.a.a.valueOf()) {
								return $author$project$Main$updatePlayAgain(wordList);
							} else {
								break _v0$5;
							}
						} else {
							var keyChar = _v0.a.a.a;
							return A2(
								$author$project$Main$updateWithGuess,
								$elm$core$Char$toUpper(keyChar),
								gameState);
						}
					}
			}
		...
		while (true) {
			if (_v0.a.$ === 'FetchedWords') {
				if (_v0.a.a.$ === 'Err') {
					...
					if (_v0.b.$ === 'Loading') {
						var wordText = _v0.a.a.a;
						var _v2 = _v0.b;
						var wordList = $elm$core$String$lines(wordText);
						return _Utils_Tuple2(
							A2($author$project$Main$Playing, wordList, $author$project$Main$initialGameState),
							$author$project$Main$chooseNewWord(wordList));
					} else {
						break _v0$3;
					}
				...
				if (_v0.b.$ === 'Playing') {
					...
					var words = _v3.a;
					var gameState = _v3.b;
					var _v4 = A3($author$project$Main$updateGameState, gameMsg, words, gameState);
					var newGameState = _v4.a;
					var cmd = _v4.b;
					return _Utils_Tuple2(
						A2($author$project$Main$Playing, words, newGameState),
						cmd);
				} else {
					break _v0$3;
				}
...
var $author$project$Main$ClickedPlayAgain = {$: 'ClickedPlayAgain'};
var $author$project$Main$maybeViewPlayAgainButton = function (showButton) {
	return showButton ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Main$GameMsg($author$project$Main$ClickedPlayAgain))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$maybeViewGameOver = function (gameState) {
	return _Utils_ap(
		$author$project$Main$playerWon(gameState) ? _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				_List_Nil,
			...
			]) : ($author$project$Main$playerLost(gameState) ? _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'The correct answer was ' + $elm$core$String$fromList(gameState.solution))
					]))
			]) : _List_Nil),
		$author$project$Main$maybeViewPlayAgainButton(
			$author$project$Main$gameIsOver(gameState)));
};
...
var $author$project$Main$render = function (count) {
	var shapesTopToBottom = _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2(297, 297)),
					$joakin$elm_canvas$Canvas$moveTo(
					_Utils_Tuple2(13, 297)),
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(13, 3)),
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(150, 3)),
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(150, 25))
				])),
			A2(
			...
			A2(
			$joakin$elm_canvas$Canvas$path,
			_Utils_Tuple2(150, 75),
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(150, 180))
				])),
			A2(
			$joakin$elm_canvas$Canvas$path,
			_Utils_Tuple2(150, 90),
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(90, 150))
				])),
			A2(
			$joakin$elm_canvas$Canvas$path,
			_Utils_Tuple2(150, 90),
			...
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$lineTo(
					_Utils_Tuple2(230, 260))
				]))
		]);
	var shapes = $elm$core$List$reverse(shapesTopToBottom);
	return A2(
		$joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
		...
		A2($elm$core$List$drop, count, shapes));
};
...
var $author$project$Main$viewGame = function (gameState) {
	var puzzle = A2($elm$core$List$map, $elm$core$String$fromChar, gameState.puzzle);
	var puzzleText = A2($elm$core$String$join, ' ', puzzle);
	var badStrings = A2($elm$core$List$map, $elm$core$String$fromChar, gameState.badGuesses);
	var badGuesses = $elm$core$List$reverse(badStrings);
	var badText = function () {
		var _v0 = gameState.badGuesses;
		if (!_v0.b) {
			return 'Press keys on your keyboard to guess letters.';
		} else {
			return 'Bad guesses: ' + A2($elm$core$String$join, ' ', badGuesses);
		}
	}();
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$render(gameState.lifeCount)
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('col-sm-7'),
						$elm$html$Html$Attributes$class('col-xs-12')
					]),
				_Utils_ap(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-monospace')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(puzzleText)
								])),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							A2(
							$elm$html$Html$p,
							...
							_List_fromArray(
								[
									$elm$html$Html$text(badText)
								]))
						]),
					$author$project$Main$maybeViewGameOver(gameState)))
			]));
};
var $author$project$Main$view = function (model) {
	switch (model.$) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Failed to load word list')
									]))
							])),
						A2(
						$elm$html$Html$p,
		...
		default:
			var wordList = model.a;
			var gameState = model.b;
			return $author$project$Main$viewGame(gameState);
	}
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GameMsg":["Main.GameMsg"],"FetchedWords":["Result.Result Http.Error String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Main.GameMsg":{"args":[],"tags":{"KeyPressed":["Main.Key"],"ClickedPlayAgain":[],"NewWord":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.Key":{"args":[],"tags":{"Character":["Char.Char"],"Control":["String.String"]}},"Char.Char":{"args":[],"tags":{"Char":[]}}}}})}});}(this));